...
public class AddprodutoSteps {
	...
	public void user_seleciona_o_produto() throws InterruptedException {
		...
		addProduto = new AddProdutoPages(driver);

		addProduto.selecionaProduto();
	}
